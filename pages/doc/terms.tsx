...
const Terms = () => {
  return (
    <div className="pt-32">
      ...
      <p>Welcome to Eucalypto Group!</p>
      ...
      <p>
        ...
        conditions. Do not continue to use Eucalypto Group if you do not agree
      ...
      <p>
        Unless otherwise stated, Eucalypto Group Innovation S.L and/or its
        licensors own the intellectual property rights for all material on
        Eucalypto Group. All intellectual property rights are reserved. You may
        access this from Eucalypto Group for your own personal use subjected to
        restrictions set in these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Eucalypto Group</li>
        <li>Sell, rent or sub-license material from Eucalypto Group</li>
        <li>Reproduce, duplicate or copy material from Eucalypto Group</li>
        <li>Redistribute content from Eucalypto Group</li>
      </ul>
      ...
      <p>
        ...
        Eucalypto Group Innovation S.L does not filter, edit, publish or review
        Comments prior to their presence on the website. Comments do not reflect
        the views and opinions of Eucalypto Group Innovation S.L,its agents
        ...
        laws, Eucalypto Group Innovation S.L shall not be liable for the
      ...
      <p>
        Eucalypto Group Innovation S.L reserves the right to monitor all
      ...
      <p>
        You hereby grant Eucalypto Group Innovation S.L a non-exclusive license
      ...
      <p>
        ...
        the hyperlink compensates the absence of Eucalypto Group Innovation S.L;
      ...
      <p>
        ...
        e-mail to Eucalypto Group Innovation S.L. Please include your name, your
