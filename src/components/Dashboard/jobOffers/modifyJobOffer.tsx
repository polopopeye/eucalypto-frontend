...
const ModifyJobOffer = () => {
  ...
  const [category, setCategory] = useState(
    store.getState().jobs.currentJobOffer.categories || []
  );
  const [techsOffer, setTechsOffer] = useState(
    store.getState().jobs.currentJobOffer.technologies ||
  ...
  store.subscribe(() => {
    ...
    setCategory(store.getState().jobs.currentJobOffer.categories || []);
    setTechsOffer(store.getState().jobs.currentJobOffer.technologies || []);
  });
